            ...
            <div class="row centered">
                <div class="col-md-8 col-md-offset-2 col-sm-8 col-sm-offset-2">
                    ...
                    <%try
                    {
                        ...
                        ResultSet rs=st.executeQuery("select *from register where role='Concumer'");
                        %>
                        <table align="center" cellpadding="10px;" border="4px;">
                            <tr><th><font color="white">First Name</th>
                                <th><font color="white">Last Name</th>
                                <th><font color="white">Email ID</th>
