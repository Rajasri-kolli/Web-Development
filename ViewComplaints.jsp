            ...
            <div class="row centered">
                <div class="col-md-8 col-md-offset-2 col-sm-8 col-sm-offset-2">
                    ...
                    <%try
                    {
                        ...
                        ResultSet rs=st.executeQuery("select distinct location from complaints");
                        %>
                        <form action="ViewLocationComplaints.jsp" method="post">
                        <table align="center" cellpadding="10px;" border="4px;">
                            <tr><td><font color="white">Select Location</td>
