        ...
        <div class="container">
            ...
            <div class="navbar-collapse collapse">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li><a href="ViewConsumers.jsp">VIEW CONSUMERS</a></li>
                    <li><a href="ViewSellers.jsp">VIEW SELLERS</a></li>
            ...
            <div class="row centered">
                <div class="col-md-8 col-md-offset-2 col-sm-8 col-sm-offset-2">
                    ...
                    <%try
                    {
                        ...
                        ResultSet rs=st.executeQuery("select * from complaints where location='"+location+"' and status='Officer'");
                        %>
                        <table align="center" cellpadding="10px;" border="4px;">
                            <tr>
                                ...
                                <th><font color="white">Accept Complaint</th>
                            ...
                            {%>
                                ...
                                <td><a href="Accept.jsp?id=<%=rs.getString(1)%>&username=<%=rs.getString(2)%>&sellername=<%=rs.getString(3)%>"><font color="white">Accept</a></td>
                            </tr>
                             <%
                            }
                    }
