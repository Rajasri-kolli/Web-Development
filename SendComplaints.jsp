        ...
        <div class="container">
            <div class="row centered">
                <div class="col-md-8 col-md-offset-2 col-sm-8 col-sm-offset-2">
                    ...
                    <h1> Send Complaint About Product</h1>
                    ...
                    <%try
                    {
                        ...
                        <table align="center" cellpadding="10px;" border="4px;">
                            <tr>
                                ...
                                <th><font color="white">Send Complaint</th>
                            ...
                            {%>
                                ...
                                <td><font color="white"><%=rs.getString(3)%></td>
                                  <td><font color="white"><%=rs.getString(4)%></td>
                                    ...
                                    <td><a href="complaint.jsp?id=<%=rs.getString(1)%>&username=<%=rs.getString(2)%>&sellername=<%=rs.getString(3)%>&pname=<%=rs.getString(4)%>&pprize=<%=rs.getString(5)%>"><font color="black">Send Complaint</a></td>
