            ...
            <div class="row centered">
                <div class="col-md-8 col-md-offset-2 col-sm-8 col-sm-offset-2">
                    ...
                    <%try
                    {
                        ...
                        ResultSet rs=st.executeQuery("select * from complaints where sellername='"+username+"' ");
                        %>
                        <table align="center" cellpadding="10px;" border="4px;">
                            <tr>
                                ...
                                <th><font color="white">Send To Officer Image</th>
                            ...
                            {%>
                                ...
                                <td><a href="ForwardToOfficer.jsp?id=<%=rs.getString(1)%>&username=<%=rs.getString(2)%>&sellername=<%=rs.getString(3)%>"><font color="white">Send To Officer</a></td>
                            </tr>
                             <%
                            }
                    }
