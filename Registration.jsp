            ...
            <div class="row centered">
                <div class="col-md-8 col-md-offset-2 col-sm-8 col-sm-offset-2">
                    ...
                    <form action="RegisterAction.jsp" method="post">
                         <tr><td><font color="white">First Name</td><td><input type="text" name="fname" required></td></tr>
                          <tr><td><font color="white">Last Name</td><td><input type="text" name="lname" required></td></tr>
                           <tr><td><font color="white">Email ID</td><td><input type="email" name="email" required></td></tr>
                            <tr><td><font color="white">Mobile </td><td><input type="text" name="mobile" required></td></tr>
                             <tr><td><font color="white">Address</td><td><input type="text" name="address" required></td></tr>
                        ...
                        <tr><td><font color="white">Select Role</td><td><select name="role">
                                    <option value="Officer">Officer</option>
                                    <option value="Concumer">Consumer</option>
